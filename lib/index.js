...
exports.getAlbumArtwork = exports.getTracks = exports.getArtists = exports.getAllAlbums = exports.setTrackToDB = exports.db = void 0;
...
exports.getAlbumArtwork = function (id) {
    var albumArtwork = exports.db
        .prepare("SELECT albumArtwork FROM albums WHERE albumId = @id")
        .get({ id: id }).albumArtwork;
    return albumArtwork;
};
